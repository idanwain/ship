COMP = g++-8.3.0
OBJS = main.o ship.o container.o port.o common.o Parser.o outputHandler.o stowage_algorithm.o lifo_algorithm.o Unsorted_Lifo_Algorithm.o WeightBalanceCalculator.o
EXEC = ex1
